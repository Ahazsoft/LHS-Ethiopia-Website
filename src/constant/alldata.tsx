...
export const headerinfo = [
    { image: IMAGES.svgicon1, title: 'Contact Us', paragraph: <Link href="tel:+11234567890" className="text-[#3b1b51]">+251943104334</Link>, },
    { image: IMAGES.svgicon2, title: 'Email Supports', paragraph: <Link href="mailto:email@domain.com" className="text-secondary">info@lhsethiopia.com</Link>, },
