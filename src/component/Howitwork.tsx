          ...
          <div className="row content-wrapper style-3">
            <div className="col-xl-4 m-b30 pe-xl-4">
              <div className="section-head style-1 m-b30">
                ...
                <p
                  ...
                  data-wow-duration="0.8s"
                >
                  We assess each case, coordinate all transport logistics, and
                  ensure continuous medical supervision throughout the journey.
                </p>
              </div>
              <div className="row">
            ...
            <div className="col-xl-8">
              <div className="content-media">
                ...
                >
                  <div className="info-widget style-8 bg-golden">
