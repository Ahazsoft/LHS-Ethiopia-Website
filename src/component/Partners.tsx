            ...
            <div className="col-xxl-3">
              <div className="section-head style-2 m-b30">
                ...
                <p
                  ...
                  data-wow-duration="0.8s"
                >
                  Trusted healthcare partners delivering safe, reliable, and
                  professionally coordinated medical care and transport with
                  clinical precision.{" "}
                </p>
              </div>
              {/* {awarddata.map((item, i) => (
                <Link
                  href={"#"}
                  scroll={false}
                  className="btn btn-outline-light btn-rounded m-r5 m-b10 wow fadeInUp"
